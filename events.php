...
//Checks every 5 mins if match has started
...
if (count($results) > 0) {
    foreach ($results as $result) {
        ...
        $ft = $client_obj->getOpenTeam($tournament_id, $client_id);
        //var_dump($ft);
        //for each client, tournament and round combination, 
        $num_rows_affected = $client_obj->autoSelectForClient($client_id, $tournament_id, $round_id, $ft);
...
$sql2 = "UPDATE lms_matches SET has_started = 1 "
